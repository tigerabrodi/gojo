...
CREATE TABLE "new_BoardRole" (
    ...
    CONSTRAINT "BoardRole_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Board" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "BoardRole_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_BoardRole" ("addedAt", "boardId", "id", "role", "userId") SELECT "addedAt", "boardId", "id", "role", "userId" FROM "BoardRole";
